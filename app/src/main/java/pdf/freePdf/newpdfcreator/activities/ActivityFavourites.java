...
import static pdf.freePdf.newpdfcreator.Constants.ADD_IMAGES_KEY;
import static pdf.freePdf.newpdfcreator.Constants.ADD_PASSWORD_KEY;
import static pdf.freePdf.newpdfcreator.Constants.ADD_WATERMARK_KEY;
import static pdf.freePdf.newpdfcreator.Constants.COMPRESS_PDF_KEY;
import static pdf.freePdf.newpdfcreator.Constants.EXCEL_TO_PDF_KEY;
import static pdf.freePdf.newpdfcreator.Constants.EXTRACT_IMAGES_KEY;
import static pdf.freePdf.newpdfcreator.Constants.HISTORY_KEY;
import static pdf.freePdf.newpdfcreator.Constants.IMAGE_TO_PDF_KEY;
import static pdf.freePdf.newpdfcreator.Constants.INVERT_PDF_KEY;
import static pdf.freePdf.newpdfcreator.Constants.MERGE_PDF_KEY;
import static pdf.freePdf.newpdfcreator.Constants.PDF_TO_IMAGES_KEY;
import static pdf.freePdf.newpdfcreator.Constants.QR_BARCODE_KEY;
import static pdf.freePdf.newpdfcreator.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static pdf.freePdf.newpdfcreator.Constants.REMOVE_PAGES_KEY;
import static pdf.freePdf.newpdfcreator.Constants.REMOVE_PASSWORD_KEY;
import static pdf.freePdf.newpdfcreator.Constants.REORDER_PAGES_KEY;
import static pdf.freePdf.newpdfcreator.Constants.ROTATE_PAGES_KEY;
import static pdf.freePdf.newpdfcreator.Constants.SPLIT_PDF_KEY;
import static pdf.freePdf.newpdfcreator.Constants.TEXT_TO_PDF_KEY;
import static pdf.freePdf.newpdfcreator.Constants.VIEW_FILES_KEY;
import static pdf.freePdf.newpdfcreator.Constants.ZIP_TO_PDF_KEY;
