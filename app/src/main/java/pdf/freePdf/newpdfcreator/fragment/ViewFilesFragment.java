...
import static pdf.freePdf.newpdfcreator.Constants.BUNDLE_DATA;
import static pdf.freePdf.newpdfcreator.Constants.REQUEST_CODE_FOR_WRITE_PERMISSION;
import static pdf.freePdf.newpdfcreator.Constants.SORTING_INDEX;
...
import pdf.freePdf.newpdfcreator.adapter.AdapterViewFiles;
import pdf.freePdf.newpdfcreator.interfaces.EmptyStateChangeListener;
import pdf.freePdf.newpdfcreator.interfaces.ItemSelectedListener;
import pdf.freePdf.newpdfcreator.util.AdsUtility;
import pdf.freePdf.newpdfcreator.util.DialogUtils;
import pdf.freePdf.newpdfcreator.util.DirectoryUtils;
import pdf.freePdf.newpdfcreator.util.FileSortUtils;
import pdf.freePdf.newpdfcreator.util.MergeHelper;
import pdf.freePdf.newpdfcreator.util.PermissionsUtils;
import pdf.freePdf.newpdfcreator.util.PopulateList;
import pdf.freePdf.newpdfcreator.util.StringUtils;
import pdf.freePdf.newpdfcreator.util.ViewFilesDividerItemDecoration;
