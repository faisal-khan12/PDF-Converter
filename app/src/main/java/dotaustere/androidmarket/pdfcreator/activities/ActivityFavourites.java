...
import static dotaustere.androidmarket.pdfcreator.Constants.ADD_IMAGES_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.ADD_PASSWORD_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.ADD_WATERMARK_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.COMPRESS_PDF_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.EXCEL_TO_PDF_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.EXTRACT_IMAGES_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.HISTORY_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.IMAGE_TO_PDF_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.INVERT_PDF_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.MERGE_PDF_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.PDF_TO_IMAGES_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.QR_BARCODE_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.REMOVE_PAGES_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.REMOVE_PASSWORD_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.REORDER_PAGES_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.ROTATE_PAGES_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.SPLIT_PDF_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.TEXT_TO_PDF_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.VIEW_FILES_KEY;
import static dotaustere.androidmarket.pdfcreator.Constants.ZIP_TO_PDF_KEY;
