...
import static dotaustere.androidmarket.pdfcreator.Constants.SORTING_INDEX;
...
import dotaustere.androidmarket.pdfcreator.adapter.AdapterViewFiles;
import dotaustere.androidmarket.pdfcreator.interfaces.EmptyStateChangeListener;
import dotaustere.androidmarket.pdfcreator.interfaces.ItemSelectedListener;
import dotaustere.androidmarket.pdfcreator.util.AdsUtility;
import dotaustere.androidmarket.pdfcreator.util.DialogUtils;
import dotaustere.androidmarket.pdfcreator.util.DirectoryUtils;
import dotaustere.androidmarket.pdfcreator.util.FileSortUtils;
import dotaustere.androidmarket.pdfcreator.util.MergeHelper;
import dotaustere.androidmarket.pdfcreator.util.PermissionsUtils;
import dotaustere.androidmarket.pdfcreator.util.PopulateList;
import dotaustere.androidmarket.pdfcreator.util.StringUtils;
import dotaustere.androidmarket.pdfcreator.util.ViewFilesDividerItemDecoration;
